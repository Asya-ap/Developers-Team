...
// Devolver un numero segun el resultado, 0 el usuario quiere salir, 1 tarea actualizada, 2 no existe ninguna tarea, sugerir crear una nueva tarea
function useUpdateMain(file = crear.archivo, user ) {
    fs.readFile(file, 'utf-8', (err, data) => {
        if(err) {
            ...
            console.log(onlyUser(user, devolver));
